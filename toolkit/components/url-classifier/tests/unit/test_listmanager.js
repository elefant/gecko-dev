...
const TEST_TABLE_DATA_LIST = [
  ...
  // 1:
  {
    tableName: "test-listmanager-1-digest256",
    providerName: "google",
    updateUrl: "http://localhost:4444/safebrowsing/update",
  ...
  // 2.
  {
    tableName: "test-listmanager-2-digest256",
    providerName: "google",
    updateUrl: "http://localhost:4444/safebrowsing/update",
...
const TEST_TABLE_DATA_ANOTHER = {
  tableName: "test-listmanager-another-digest256",
  providerName: "google",
...
function getNextUpdateTime() {
  try {
    return prefBranch.getIntPref(PREF_NEXTUPDATETIME);
  } catch (e) {
    return parseInt(prefBranch.getCharPref(PREF_NEXTUPDATETIME));
  }
}
...
function forceTableUpdate() {
  prefBranch.setIntPref(PREF_NEXTUPDATETIME, 1);
