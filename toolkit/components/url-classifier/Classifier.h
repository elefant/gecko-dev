...
public:
  ...
  nsresult SwapInNewTables();

  // Swap in only in-memory databases.
  void SwapInNewLookupCaches();
...
private:
  ...
  // The LookupCache placeholder for update. Should only be accessed
  // via GetLookupCacheForUpdate().
